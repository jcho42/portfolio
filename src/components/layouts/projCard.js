...
export default function ProjectCard({
  ...
  return (
    <div className="relative flex-100 max-w-md md:flex-1/2 lg:flex-1/3">
      ...
      <div className={`absolute p-5 top-0 bottom-0 left-0 right-0 bg-${picture} bg-contain bg-no-repeat hover:bg-none`}>
        <div className="h-full flex flex-col justify-center opacity-0 hover:opacity-100">
